    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="homeButtons__touchdown" onClick={() => updateLionsScore(lionsScore + 6)}>Home Touchdown</button>
          <button className="homeButtons__fieldGoal" onClick={() => updateLionsScore(lionsScore + 3)}>Home Field Goal</button>
        </div>
        <div className="awayButtons">
          <button className="awayButtons__touchdown" onClick={() => updateTigersScore(tigersScore + 6)}>Away Touchdown</button>
